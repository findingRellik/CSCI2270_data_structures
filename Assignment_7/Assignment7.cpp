//Austin Metzner, Assignment 7, Yang Li
#include <iostream>
#include "MovieTree.h"
#include <fstream>
#include <sstream>
...
//OPTION 4 delete movie
        else if(userInput == "4"){
            cout<<"Enter title:"<<endl;
            getline(cin,userInput);
            theTree->deleteMovieNode(userInput);
        }
//OPTION 5 count movies
        else if(userInput == "5"){
            cout<<"Tree contains: "<<theTree->countMovieNodes()<<" movies."<<endl;
        }
    }
    cout<<"Goodbye!"<<endl;
    delete theTree;
